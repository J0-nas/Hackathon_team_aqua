boolean collectIMU_Measurement() {
  ...
  struct IMU_Measurement imu = {AcX, AcY, AcZ, Tmp, GyX, GyY, GyZ};

  //boolean full = writeIMU_Measurement(imu);
  boolean full = sendIMU_Measurement(imu);
  return full;
}
